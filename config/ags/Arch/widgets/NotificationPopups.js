...
export default (monitor) => {
    ...
    return (_jsx("window", { gdkmonitor: monitor, className: "NotificationPopups", name: "notification-popups", namespace: "notification-popups", application: App, exclusivity: Astal.Exclusivity.EXCLUSIVE, layer: Astal.Layer.OVERLAY, anchor: TOP | RIGHT, margin: globalMargin, widthRequest: 400, child: _jsx("box", { vertical: true, vexpand: true, spacing: globalMargin, noImplicitDestroy: true, children: bind(notifications) }) }));
};
